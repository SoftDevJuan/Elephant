...
public class HomeAux extends javax.swing.JFrame {
int ejex, ejey;
...
public String getUsuario() {
    ...
    private void initComponents() {
        ...
        FONDO.add(pnPedido, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 270, 200, 50));
        ...
        FONDO.add(pnTransferencia, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 210, 200, 50));
...
public String contarTicketsZPC(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HomeAux.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
